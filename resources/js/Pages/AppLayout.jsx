...
function buildNav(tr) {
    return [
        ...
        { href:"/calendar",     label:tr.calendar,     icon:<svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 2v4m8-4v4M3 9h18M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z"/></svg> },
...
export default function AppLayout({ children }) {
    ...
    return (
        <>
            ...
            {/* Interactive onboarding guide (persistent, survives navigation) */}
            <GuidedTour />
        </>
    );
}